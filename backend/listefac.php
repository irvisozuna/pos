...
if (!$user->rights->pos->backend)
{
	...
	if ($page == -1) $page = 0 ;
	 ...
	 $sql = 'SELECT';
        ...
        $sql.= ' u.lastname';//AMM 1 20140327 cambio u.name por u.lastname
        ...
        if ($_GET['search_user'])
        {
        	$sql.= ' AND u.lastname LIKE \'%'.$db->escape(trim($_GET['search_user'])).'%\'';//AMM 1 20140327 cambio u.name por u.lastname
        }
