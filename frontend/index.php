...
global $user,$conf,$db;
/*dol_syslog("ESTE  UID: ".$user->id);
$sql0= "SELECT fk_cashgroup
		FROM llx_pos_cashgroup_cash
		WHERE fk_user=".$user->id;
$rst1=$db->query($sql0);
$rest3=$db->fetch_object($rst1);
$sql1='UPDATE llx_pos_cash SET is_closed=1 WHERE rowid='.$rest3->fk_cashgroup;
dol_syslog('ESTE QUERY ACTUALIZA: '.$sql1);
$rst=$db->query($sql1);
*/
$usertxt=$user->login;
$pwdtxt=$user->pass;
