...
class modPos extends DolibarrModules
{
	...
	function modPos($DB)
	{
		...
		*/
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=18',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									'type'=>'left',			// This is a Left menu entry
									'titre'=>'Asignar Usuario a Caja', //'titre'=>'Terminal Group',
									'mainmenu'=>'@pos',
									'url'=>'/pos/backend/terminal/cashgroup.php',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>102,
									'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		//
		// Example to declare another Left Menu entry:
		$this->menu[$r]=array(	'fk_menu'=>'r=22',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
				'type'=>'left',			// This is a Left menu entry
				'titre'=>'NewPlace',
				'mainmenu'=>'@pos',
		...
		// Example to declare another Left Menu entry:
		 ...
		 //
		 // Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=35',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
							 		'type'=>'left',			// This is a Left menu entry
							 		'titre'=>'Factures',
							 		'mainmenu'=>'@pos',
